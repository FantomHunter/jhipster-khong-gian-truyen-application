...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .type(DEFAULT_TYPE)
            .totalChapter(DEFAULT_TOTAL_CHAPTER);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            ...
            .type(UPDATED_TYPE)
            .totalChapter(UPDATED_TOTAL_CHAPTER);
        return product;
    }
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getTotalChapter()).isEqualTo(DEFAULT_TOTAL_CHAPTER);
    }
    ...
    void putNewProduct() throws Exception {
        ...
        assertThat(testProduct.getTotalChapter()).isEqualTo(UPDATED_TOTAL_CHAPTER);
    }
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.status(UPDATED_STATUS).type(UPDATED_TYPE);
