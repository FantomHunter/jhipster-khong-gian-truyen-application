...
class LikeResourceIT {
    ...
    void createLike() throws Exception {
        ...
        assertThat(testLike.getLikeDate()).isEqualTo(DEFAULT_LIKE_DATE);
    }
    ...
    void putNewLike() throws Exception {
        ...
        updatedLike.likeDate(UPDATED_LIKE_DATE);
        ...
        Like testLike = likeList.get(likeList.size() - 1);
        assertThat(testLike.getLikeDate()).isEqualTo(UPDATED_LIKE_DATE);
    }
    ...
    void partialUpdateLikeWithPatch() throws Exception {
        ...
        partialUpdatedLike.likeDate(UPDATED_LIKE_DATE);
