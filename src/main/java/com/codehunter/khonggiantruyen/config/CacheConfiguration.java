package com.codehunter.khonggiantruyen.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.codehunter.khonggiantruyen.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.codehunter.khonggiantruyen.repository.UserRepository.USERS_BY_EMAIL_CACHE);
