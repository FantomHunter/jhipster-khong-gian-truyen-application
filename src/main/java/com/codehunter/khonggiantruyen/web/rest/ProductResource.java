...
/**
 * REST controller for managing {@link com.codehunter.khonggiantruyen.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                ...
                if (product.getTotalChapter() != null) {
                    existingProduct.setTotalChapter(product.getTotalChapter());
                }
