  ...
  describe('Service methods', () => {
    ...
    describe('addDownloadToCollectionIfMissing', () => {
      ...
      it('should add only unique Download to an array', () => {
        const downloadArray: IDownload[] = [{ id: 123 }, { id: 456 }, { id: 58361 }];
      ...
      it('should return initial array if no Download is added', () => {
        const downloadCollection: IDownload[] = [{ id: 123 }];
        expectedResult = service.addDownloadToCollectionIfMissing(downloadCollection, undefined, null);
        expect(expectedResult).toEqual(downloadCollection);
      });
    });
  });
