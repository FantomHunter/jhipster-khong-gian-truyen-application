...
describe('ResourceDownload Management Component', () => {
  let comp: ResourceDownloadComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ResourceDownloadComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.resourceDownloads[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
